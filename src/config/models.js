...
const MODELS = [
  ...
  },
  {
    ...
    preview: false,
    sharedEmbeddingSpace: null,
    note: 'Runs in-browser. No API key needed. ~33 MB download. Prepend "query:" for queries.',
  },
  {
  ...
  {
    id: 'huggingface/mixedbread-ai/mxbai-embed-xsmall-v1',
    provider: 'huggingface',
    name: 'mixedbread-ai/mxbai-embed-xsmall-v1',
    displayName: 'mxbai-embed-xsmall-v1',
    dimensions: 384,
    maxTokens: 512,
    maxBatchSize: 32,
    inputType: 'text',
  ...
  },
  {
    ...
    inputType: 'text',
    supportsMatryoshka: true,
    matryoshkaDimensions: [768, 512, 256, 128, 64],
    outputDtypes: null,
    apiEndpoint: null,
    preview: false,
    sharedEmbeddingSpace: null,
    note: 'Runs in-browser. No API key needed. ~34 MB download. Client-side Matryoshka truncation.',
  },
  {
    id: 'huggingface/onnx-community/embeddinggemma-300m-ONNX',
    provider: 'huggingface',
    ...
    preview: false,
    sharedEmbeddingSpace: null,
    note: 'Runs in-browser. No API key needed. ~150 MB download. High quality but large.',
  },
];
